...
class SearchOrderAdapter(private val orderList: List<OrderItemListModel>, private val listener: OnItemClickListener) : RecyclerView.Adapter<SearchOrderAdapter.OrderViewHolder>() {
