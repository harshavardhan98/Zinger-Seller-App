...
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_ACCEPTED
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_CANCELLED_BY_SELLER
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_CANCELLED_BY_USER
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_COMPLETED
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_DELIVERED
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_OUT_FOR_DELIVERY
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_PENDING
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_PLACED
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_READY
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_REFUND_COMPLETED
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_REFUND_INITIATED
import com.food.ordering.zinger.seller.utils.AppConstants.ORDER_STATUS_TXN_FAILURE
